...
public class UiUtil {
    ...
    private static boolean setCustomFont(View textViewOrButton, Context ctx, String asset) {
        ...
        try {
            ...
            } else if(textViewOrButton instanceof RadioButton){
            	((RadioButton) textViewOrButton).setTypeface(tf);
            } else if(textViewOrButton instanceof CheckBox){
            	((CheckBox) textViewOrButton).setTypeface(tf);
            } 
        } catch (Exception e) {
